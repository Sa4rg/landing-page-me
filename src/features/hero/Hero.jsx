...
/**
 * Hero section - Main landing section with personal introduction
 * 
 * @component
 * @example
 * <Hero onViewProjects={() => scrollToProjects()} />
 */
export function Hero({ onViewProjects, onDownloadCV }) {
    ...
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="max-w-4xl mx-auto text-center">
          {/* Greeting */}
          <p className="text-lg text-primary-600 dark:text-primary-400 font-medium mb-4 animate-fade-in">
            Hi, my name is
          </p>
          ...
          {/* Title */}
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-700 dark:text-gray-300 mb-6">
...
Hero.propTypes = {
  /** Callback when View Projects is clicked */
  onViewProjects: PropTypes.func,
  
  /** Callback when Download CV is clicked */
